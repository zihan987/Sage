<template>
  <div
    class="mb-4 rounded-2xl border border-border/70 bg-background/88 px-4 py-3 shadow-[0_10px_28px_rgba(15,23,42,0.06)] backdrop-blur-sm dark:border-white/10 dark:bg-[rgba(8,8,10,0.92)] dark:shadow-[0_12px_30px_rgba(0,0,0,0.28)]"
  >
